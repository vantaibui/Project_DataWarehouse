...
public class Date_Dim {
	...
	public static final int NUMBER_OF_RECORD = 10950;
	public static final String TIME_ZONE = "PST8PDT";
public static void main(String[] args) {
	new  Date_Dim().getDate();
}
	public List<String> getDate(){
		DateTimeZone dateTimeZone = DateTimeZone.forID(TIME_ZONE);
		int count = 0;
		int date_sk = 0;
		int month_since_1980 = 1;
		int day_since_1980 = 0;
		int quarter_since_1980_temp = 0;
		int quarter_temp = 1;
		PrintWriter pr = null;
		...
		DateTime startDateTime = new DateTime(1979, 12, 31, 0, 0, 0);
		...
		while (count <= NUMBER_OF_RECORD) {
			...
			// Month Since 2005
			month_since_1980 = month_since_2005_temp + 1;
			// Day of Week
			...
			if (quarter == quarter_temp) {
				quarter_since_1980_temp = quarter_since_1980_temp + 1;
				quarter_temp += 1;
				if (quarter_temp > 4) {
					quarter_temp = 1;
				}
			...
			int quarter_since_1980= 0;
			quarter_since_1980 += quarter_since_1980_temp;
			...
			String output = date_sk + "," + full_date + "," + day_since_1980
					+ "," + month_since_1980 + "," + day_of_week + ","
