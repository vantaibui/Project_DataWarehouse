		  ...
		  public static void BuiltDataMonHoc() throws SQLException{
			...
			preparedStatement.executeUpdate();
				  ...
				  for(MonHoc MH:listMH) {
					  ...
					  String sql3= "delete from stagingdb.monhoc where ma_mh="+MH.getMaMH();
		  ...
		  public static void BuiltDataDangKi() throws SQLException{	
				...
				String tgdk="";
				  ...
				  for(DangKy dk:listDK) {
					  ...
					  String sql3= "delete from stagingdb.dangky where ma_dk="+dk.getMaDK();
					  try {
						  pst= cdb.connectDBWarehouse().prepareStatement(sql2);
			  ...
			  String MaLH;
				...
				String namhoc;
				  ...
				  for(Lop LH:listLH) {
					  ...
					  String sql3= "delete from stagingdb.lop where ma_lh="+LH.getMaLH();
